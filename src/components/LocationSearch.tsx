 ...
 const handleSubmit = async (event: React.FormEvent<HTMLFormElement>)=>{
    ...
    return (<div>
        <form onSubmit={handleSubmit}>
            ...
            <input id="term" className="border border-gray-300 rounded-md shadow-sm focus:border-indigo-500 px-4 py-2 w-full" value={term} onChange={(e=> setTerm(e.target.value))} />
        </form>
        ...
        <div className="grid grid-cols-[1fr-40px] gap-2 mt-2 items-center">
            {places.map(place=>{
                ...
                <div className="border-b w-full col-span-2"/>                </Fragment>
            })}
        </div>
    </div>)
}